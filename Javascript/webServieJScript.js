window.onload = function () {
    var placeRadioButtonListItems =
    document.getElementById("placeRadioButtonList").getElementsByTagName("input");
...
function showPlaceData(placeData) {
    document.getElementById("placeImage").src = "http://farm9.staticflickr.com/" + placeData.flickrId;
